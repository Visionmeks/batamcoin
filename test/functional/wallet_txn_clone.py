...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # All nodes should start with 1,250 GLC:
        ...
        # Node0's balance should be starting balance, plus 50GLC for another
        ...
        # Check node0's total balance; should be same as before the clone, + 100 GLC for 2 matured,
